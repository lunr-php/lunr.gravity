 ...
 */
class SQLite3DMLQueryBuilderGroupByTest extends SQLite3DMLQueryBuilderTestCase
{

    /**
     * Test specifying the group by part of a query with default order.
     *
     * @covers Lunr\Gravity\SQLite3\SQLite3DMLQueryBuilder::group_by
     */
    public function testGroupByWithDefaultOrder(): void
    {
        $this->class->group_by('group1');
        $value = $this->getReflectionPropertyValue('groupBy');
