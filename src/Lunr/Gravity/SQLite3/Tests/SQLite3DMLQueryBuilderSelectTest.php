 ...
 */
class SQLite3DMLQueryBuilderSelectTest extends SQLite3DMLQueryBuilderTestCase
{
     ...
     * @covers       Lunr\Gravity\SQLite3\SQLite3DMLQueryBuilder::select_mode
     */
     ...
     *
     * @covers Lunr\Gravity\SQLite3\SQLite3DMLQueryBuilder::lock_mode
     */
     ...
     *
     * @covers Lunr\Gravity\SQLite3\SQLite3DMLQueryBuilder::except
     */
    public function testIfExceptReturnsSelfReference()
    {
        $except = $this->class->except('query');

        $this->assertInstanceOf('Lunr\Gravity\SQLite3\SQLite3DMLQueryBuilder', $except);
     ...
     *
     * @covers Lunr\Gravity\SQLite3\SQLite3DMLQueryBuilder::intersect
     */
    public function testIfIntersectReturnsSelfReference()
    {
        $intersect = $this->class->intersect('query');

        $this->assertInstanceOf('Lunr\Gravity\SQLite3\SQLite3DMLQueryBuilder', $intersect);
