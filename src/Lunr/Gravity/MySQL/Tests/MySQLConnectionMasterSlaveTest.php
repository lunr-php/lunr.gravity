 ...
 */
class MySQLConnectionMasterSlaveTest extends MySQLConnectionTestCase
{

    /**
     * Test that run_on_master() sets the correct default query hint.
     *
     * @covers Lunr\Gravity\MySQL\MySQLConnection::run_on_master
     */
     ...
     *
     * @covers Lunr\Gravity\MySQL\MySQLConnection::run_on_slave
     */
